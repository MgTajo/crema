...
export const DE = {
  ...
  'Free for a limited time while Crema is young. Switch it on right here, with no card and no trial countdown. Billing comes later, and we will ask first.':
    'Solange Crema jung ist, für begrenzte Zeit kostenlos. Schalt es gleich hier ein, ohne Karte und ohne Countdown. Abgerechnet wird später, und wir fragen vorher.',
  'Turn Premium on, free':'Premium einschalten, kostenlos',
  ...
  'New features land here first':'Neue Funktionen landen hier zuerst',
  '<b>{what}</b> is a Premium feature, <u>free for now, switch it on in Settings</u>.':
    '<b>{what}</b> ist eine Premium-Funktion, <u>vorerst kostenlos, schalt sie in den Einstellungen ein</u>.',
  ...
  'Pinning is Premium, free right now. Switch it on in Settings.':'Anpinnen ist Premium, gerade kostenlos. Schalt es in den Einstellungen ein.',
  ...
  'Pin the ones you use most to hold them at the top. That is Premium, <u>free for now, switch it on in Settings</u>.':
    'Pinn die an, die du am meisten nutzt, dann bleiben sie oben. Das ist Premium, <u>vorerst kostenlos, schalt es in den Einstellungen ein</u>.',
  'Common ones':'Häufige',
  'Popular':'Beliebt',
