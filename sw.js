...
/* The cache name and the precache list are GENERATED — see
   ...
   C is now a content hash of everything in the list, so it changes
   exactly when the precached bytes change. That is also still the lever
   for evicting a bad cache — activate() purges every cache that is not
   C — but it is pulled automatically rather than remembered.
