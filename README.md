...
| **Profile** | Level + points progress bar, recent-activity chart with hover tooltips, recent coffees strip, **bean passport** — every coffee you have logged, with roaster, origin, roast and how often you have poured it, plus per-bean detail pages, pours/saved/badges/stats tabs, **10 badges** with progress. |
