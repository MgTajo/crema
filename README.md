...
| **Explore** | Working search (people, beans, cafés, pours), challenges with **entry submission** and per-challenge leaderboards, full weekly leaderboard, trending pattern feeds (#rosetta …). |
